        ...
        return (
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <KeyboardAvoidingView style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        <TextInput style={{ height: 200, width: 400, borderColor:'#21396b',borderWidth:1,marginBottom:10,padding:10,fontSize:15}} multiline={true} placeholder='Question..' value={this.state.question}
                            onChangeText={(question) => this.setState(() => ({question}))}
                        />
                        <TextInput style={{ height: 200, width: 400, borderColor: '#21396b', borderWidth: 1,marginBottom:10,padding:10,fontSize:15}} multiline={true} placeholder='Answer..' value={this.state.answer}
